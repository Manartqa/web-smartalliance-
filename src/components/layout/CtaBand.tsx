...
const defaultIcons: Record<CtaBandProps["variant"], string> = {
  home: "/assets/ic-mail-circle.png",
  services: "/assets/cta-share.png",
  contact: "/assets/cta-handshake.png",
};

export function CtaBand({ variant, icon }: CtaBandProps) {
